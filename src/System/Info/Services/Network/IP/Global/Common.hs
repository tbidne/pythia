...
--
-- @since 0.1.0.0
module System.Info.Services.Network.IP.Global.Common
  ( globalIpShellApp,
  )
where
...
import System.Info.Data qualified as Data
...
import System.Info.Services.Network.IP.Global.Types qualified as IpTypes
import System.Info.ShellApp (GeneralShell (..), QueryResult, ShellApp (..))
